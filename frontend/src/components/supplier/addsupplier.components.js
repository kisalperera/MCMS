...
<div className="p-3 border bg-light">
            ...
            <input type="text" className="form-control" id="item_name" value ={this.state.name} onChange={this.onChangeName} ></input>
            <br/>

            <label for="brand_name" className="form-label">Email</label>
            <input type="text" className="form-control" id="brand_name" value ={this.state.email} onChange={this.onChangeEmail} ></input>
            <br/>

            <label for="brand_name" className="form-label">Phone No</label>
            <input type="text" className="form-control" id="brand_name" value ={this.state.phone} onChange={this.onChangePhone} ></input>
            <br/>

            <label for="brand_name" className="form-label">Address</label>
            <textarea type="text" className="form-control" id="brand_name" value ={this.state.address} onChange={this.onChangeAddress} ></textarea>
            <br/>
