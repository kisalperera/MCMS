...
<form onSubmit={this.onSubmit} >
            ...
            <input type="text" className="form-control"  value ={this.state.unit_price} onChange={this.onChangeUnitPrice}></input>
            ...
            <input type="text" className="form-control" value ={this.state.selling_price} onChange={this.onChangeSellingPrice}></input>
            <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1">Rs</span></div>
</div>
            </div>
            ...
            <input type="text" className="form-control" value ={this.state.reorder_level} onChange={this.onChangeReorder}></input>
</div>
            </div>
