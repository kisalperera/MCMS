...
componentDidMount(){
    axios.get('http://localhost:5000/inventoryItems/'+this.props.match.params.id)
    .then(response=> {
        this.setState({
...
onSubmit(e){
    ...
    axios.post('http://localhost:5000/inventoryItems/update/'+this.props.match.params.id, inventoryItem)
